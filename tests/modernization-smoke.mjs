...
const sw=read('service-worker.js');assert.match(sw,/SKIP_WAITING/);assert.match(sw,/url\.origin!==self\.location\.origin/);assert.doesNotMatch(sw,/supabase\.co/);assert.match(sw,/assets\/ts\/public\/date\.js/);
